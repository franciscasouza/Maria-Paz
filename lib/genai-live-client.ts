...
export class GenAILiveClient extends EventEmitter<LiveClientEventTypes> {
  // Fix: Re-declare EventEmitter methods to fix type resolution issues.
  declare on: <K extends keyof LiveClientEventTypes>(event: K, listener: LiveClientEventTypes[K]) => this;
  declare off: <K extends keyof LiveClientEventTypes>(event: K, listener: LiveClientEventTypes[K]) => this;
  declare emit: <K extends keyof LiveClientEventTypes>(event: K, ...args: Parameters<LiveClientEventTypes[K]>) => boolean;
